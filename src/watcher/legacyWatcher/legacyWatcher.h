...
namespace legacyWatcher
{
    ...
    typedef enum {
        ...
        Base = 1 << COMMUNICATIONS_LABEL_FAMILY_ROUTING,
        GroupA = 1 << COMMUNICATIONS_LABEL_FAMILY_ROUTING_ONEHOP,
        GroupB = 1 << COMMUNICATIONS_LABEL_FAMILY_RESERVED_16,
        GroupD = 1 << COMMUNICATIONS_LABEL_FAMILY_RESERVED_17,
        GroupE = 1 << COMMUNICATIONS_LABEL_FAMILY_ANOMPATHS,
        Mission = 1 << COMMUNICATIONS_LABEL_FAMILY_CORRELATION,
        GroupAChildren = 1 << COMMUNICATIONS_LABEL_FAMILY_ALERT,
        GroupBChildren = 1 << COMMUNICATIONS_LABEL_FAMILY_CORRELATION_3HOP,
        GroupDChildren = 1 << COMMUNICATIONS_LABEL_FAMILY_ROUTING2,
        GroupEChildren = 1 << COMMUNICATIONS_LABEL_FAMILY_ROUTING2_ONEHOP,
        MissionChildren = 1 << COMMUNICATIONS_LABEL_FAMILY_NORMPATHS,
