...
namespace sqlite_wrapper {
    ...
    int sqlite_binder(sqlite3_stmt*s, int pos, const std::string&);
    ...
    class Column {
        ...
        public:
             ...
             */
            template <typename T, int N> Column& get(T (&val)[N], size_t nelems = N)
            {
                return get(&val[0], N);
            }
            ...
            template <typename T, int N> Column& operator>> (T (&val)[N])
            {
                return get(&val[0], N);
            }
    ...
    class Statement {
        ...
        public:
            ...
            template <typename T, int N> Statement& bind(const T (&val)[N] )
            {
                return bind(val, N);
            }
            ...
            template <typename T, int N> Statement& operator<< (const T (&val) [N])
            {
                return bind(val, N);
            }
