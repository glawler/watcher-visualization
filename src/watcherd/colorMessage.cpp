...
ostream &watcher::operator<<(ostream &out, const ColorMessage &mess)
{
    TRACE_ENTER();
    mess.operator<<(out);
    TRACE_EXIT();
...
void ColorMessage::serialize(boost::archive::polymorphic_iarchive & ar, const unsigned int file_version)
{
    TRACE_ENTER();
...
void ColorMessage::serialize(boost::archive::polymorphic_oarchive & ar, const unsigned int file_version)
{
    TRACE_ENTER();
    ar & boost::serialization::base_object<Message>(*this);
    ar & color;
