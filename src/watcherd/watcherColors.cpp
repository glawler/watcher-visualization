...
INIT_LOGGER(watcher::Color, "Color");
BOOST_CLASS_EXPORT_GUID(watcher::Color, "watcher::Color");
...
ostream &watcher::operator<<(ostream &out, const Color &c)
{
    TRACE_ENTER();
    c.operator<<(out);
    TRACE_EXIT();
...
void Color::serialize(boost::archive::polymorphic_iarchive & ar, const unsigned int file_version)
{
    TRACE_ENTER();
    ar & r;
    ar & g;
...
void Color::serialize(boost::archive::polymorphic_oarchive & ar, const unsigned int file_version)
{
    TRACE_ENTER();
    ar & r;
    ar & g;
