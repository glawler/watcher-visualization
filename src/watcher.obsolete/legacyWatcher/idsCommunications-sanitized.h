 ...
 * ids nodes.
 *
 * Copyright (C) 2005  Networks Associates Technology, Inc.
 * Copyright (C) 2005  McAfee Research
 * Copyright (C) 2006,2007  Sparta Inc.  Written by the NIP group, SRD, ISSO
 *
 * $Id: idsCommunications.h,v 1.93 2007/08/22 18:20:46 dkindred Exp $
 */
 ...
 * each that node should use.
 * Then, pass that vector to IDSStateSet, and it will
 ...
 */
ManetAddr communicationsHostnameLookup(char *nam);
