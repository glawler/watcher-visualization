...
namespace randomScenario {
    ...
    bool loadConfiguration(int argc, char **argv)
    {
        ...
        config.add_options()
            ...
            ("depth,D", value<unsigned int>()->default_value(1000), "Max depth of the playing field. (Up/Down)")
            ("height,H", value<unsigned int>()->default_value(100), "Max height of the playing field. (North/South)")
