...
namespace randomScenario {
    ...
    bool loadConfiguration(int argc, char **argv)
    {
        ...
        options_description generic("Command line only options");
        generic.add_options()
        ...
        // 
        string logLevel;
        options_description config("Command line and configuration file options (command line will override config file)");
        config.add_options()
