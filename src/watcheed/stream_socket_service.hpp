...
namespace services 
{
    ...
    class stream_socket_service : public boost::asio::io_service::service
    {
        private:
                ...
                logger_(io_service, "stream_socket")
        {
            ...
            {
                logger_.log("Starting asynchronous connect to " + boost::lexical_cast<std::string>(peer_endpoint));
            ...
            std::size_t send(implementation_type& impl, const Const_Buffers& buffers, boost::asio::socket_base::message_flags flags, boost::system::error_code& ec)
            {
            ...
            template <typename Const_Buffers, typename Handler>
             void async_send(implementation_type& impl, const Const_Buffers& buffers, boost::asio::socket_base::message_flags flags, Handler handler)
             {
                 ...
                 service_impl_.async_send(impl, buffers, flags, send_handler<Handler>(handler, logger_));
             }
